...
# curl -X POST http://localhost:5000/main/api/predict -H "Content-Type: application/json" -H "x-api-key: your_strong_api_key_here" -d "{\"sepal_length\":5.1,\"sepal_width\":3.5,\"petal_length\":1.4,\"petal_width\":0.2}"
